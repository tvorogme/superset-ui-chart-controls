...
export const dnd_adhoc_metric_2 = { ...dnd_adhoc_metric,
...
export const dnd_size = { ...dnd_adhoc_metric,
  label: t('Bubble Size'),
  description: t('Metric used to calculate bubble size')
};
export const dnd_x = { ...dnd_adhoc_metric,
  label: t('X Axis'),
  description: t('Metric assigned to the [X] axis')
};
export const dnd_y = { ...dnd_adhoc_metric,
  label: t('Y Axis'),
  description: t('Metric assigned to the [Y] axis')
};
export const dnd_secondary_metric = { ...dnd_adhoc_metric,
  label: t('Color Metric'),
  validators: [],
  description: t('A metric to use for color')
};
export const dnd_granularity_sqla = { ...dndSeries,
  ...
  canDelete: false,
  ghostButtonText: t(isFeatureEnabled(FeatureFlag.ENABLE_DND_WITH_CLICK_UX) ? 'Drop a temporal column here or click' : 'Drop temporal column here'),
  mapStateToProps: ({
    datasource
  }) => {
